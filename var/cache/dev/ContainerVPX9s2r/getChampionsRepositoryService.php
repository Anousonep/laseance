 ...
 */
class getChampionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChampionsRepository' shared autowired service.
     *
     * @return \App\Repository\ChampionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChampionsRepository.php';

        return $container->privates['App\\Repository\\ChampionsRepository'] = new \App\Repository\ChampionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
